...
Start a substantial phase by recording material choices, options, consequences, and a recommendation. Write a failing test; implement minimally; run focused and full checks; clean up; rerun; update docs; review `git diff`; commit and push to GitHub as step 8.
